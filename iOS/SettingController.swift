...
class SettingController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        TimeOrderSwitch.on = defaults.boolForKey("TimeOrderKey")
...
/*
    ...
    @IBOutlet var TimeOrderSwitch: UISwitch!
    @IBAction func SaveSwitchState(sender: UISwitch) {
        
        if TimeOrderSwitch.on{
            defaults.setBool(true, forKey: "TimeOrderKey")
        }else{
            defaults.setBool(false, forKey: "TimeOrderKey")
        }
